(() => {
  ...
  // extensions/order-task-create/src/ActionExtension.jsx
  ...
  function App() {
    ...
    console.log({ data });
    const [orderId, setOrderId] = (0, import_react12.useState)(null);
    const [orderName, setOrderName] = (0, import_react12.useState)(null);
    (0, import_react12.useEffect)(() => {
      (function getOrderInfo() {
        return __async(this, null, function* () {
          ...
          const orderData = yield res.json();
        ...
        AdminAction2,
        {
          primaryAction: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Button2,
            {
              ...
              to: `/apps/notedesk-2/newTask?orderId=${orderId ? orderId.replace("gid://shopify/Order/", "") : null}&orderName=${orderName ? orderName.replace("#", "") : null}`,
...
//# sourceMappingURL=order-task-create.js.map
